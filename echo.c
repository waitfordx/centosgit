...
void buf_error_callback(struct buffevent *bev, short what, void *arg)
{
...
int main()
{
	...
	if(socketlisten < 0)
	{
		fprintf(stderr, "Failed to create listen socker");
		return 1;
	}
	...
	{
		fprintf(stderr, "Faired to bind");
		return 1;
	}

	if(listen(socketlisten, 5) < 0)
	{
		fprintf(stderr, "Faired to listen to socket");
		return 1;
	}
